...
/**
 * Clase VentanaDepart esta clase dibuja la ventana para la gestión de los datos del
 * fichero AleatorioDep.dat
 * 
...
public class VentanaDepart extends JFrame implements ActionListener {
	...
	/**
	 * Constructor. Dibuja la ventana, recibe el frame donde la va a dibujar.
	 */
	...
	/**
	 * Método verporconsola Este método visualiza los datos del fichero en la consola.
	 * 
	 * @throws IOException
	 */
